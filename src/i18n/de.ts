...
export const de: Dict = {
  ...
  send: {
    title: "Geld senden",
    body: "Sofort an ein anderes Trustline-Konto senden oder an eine externe Bank, die unser Team bearbeitet.",
    recipient: "Empfänger",
    recipientHint: "Für einen anderen Trustline-Kunden geben Sie dessen Kontonummer oder E-Mail ein. Für eine externe Bank beschreiben Sie Empfänger und Konto.",
    submit: "Senden",
