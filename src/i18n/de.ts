...
export const de: Dict = {
  ...
  products: {
    ...
    tierHint: "Kartenstufen bedürfen der Genehmigung — unser Team bestätigt Stufe und Limit.",
    tiers: {
      GOLD: "Gold",
      PLATINUM: "Platinum",
      BLACK: "Black",
    ...
    tierBlurbs: {
      GOLD: "Alltagsvorteile und ein Einstiegslimit.",
      PLATINUM: "Höhere Limits, Reiseschutz, bevorzugter Support.",
