...
export const de: Dict = {
  ...
  dashboard: {
    ...
    emailSubject: "Trustline — Supportanfrage",
  ...
  services: {
    ...
    cardsNote: "Ihre Trustline-Karten und deren Einstellungen.",
    ...
    taxStep3: "Er reicht Ihre Erstattung ein, die auf Ihr Trustline-Konto ausgezahlt wird.",
    ...
    taxLede: "Beantragen Sie eine Erstattung auf Ihr Trustline-Konto. Die Identität wird über die sichere Anmeldung von ID.me bestätigt — wir fragen hier nie nach Ihrem ID.me-Passwort.",
    taxYear: "Steuerjahr",
  ...
  setup2fa: {
    ...
    subtitle: "Trustline verlangt die Zwei-Faktor-Prüfung. Aktivieren Sie sie jetzt, um fortzufahren.",
  ...
  payments: {
    ...
    instantNote: "Dieser Empf\u00e4nger ist Trustline-Kunde \u2013 die Zahlung kommt sofort an.",
    ...
    kindInternal: "Ein anderer Trustline-Kunde",
    method: "Zahlungsweg",
    accountRef: "Kontonummer oder Kennung",
    accountRefInternal: "Trustline-Kontonummer oder E-Mail-Adresse",
    ...
    internalNotFound: "Zu dieser Nummer oder E-Mail-Adresse geh\u00f6rt kein aktives Trustline-Konto.",
