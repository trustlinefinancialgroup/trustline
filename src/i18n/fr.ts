...
export const fr: Dict = {
  ...
  dashboard: {
    ...
    emailSubject: "Trustline — demande d'assistance",
  ...
  services: {
    ...
    taxStep3: "Il déclare votre remboursement, versé sur votre compte Trustline.",
  ...
  setup2fa: {
    ...
    subtitle: "Trustline exige la vérification en deux étapes. Activez-la pour accéder à votre tableau de bord.",
