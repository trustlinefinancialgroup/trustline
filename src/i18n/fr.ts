...
export const fr: Dict = {
  ...
  products: {
    ...
    tierHint: "Les gammes sont soumises à approbation — notre équipe confirme la gamme et le plafond définitifs.",
    tiers: {
      GOLD: "Gold",
      PLATINUM: "Platinum",
      BLACK: "Black",
    ...
    tierBlurbs: {
      GOLD: "Récompenses au quotidien et plafond de départ.",
      PLATINUM: "Plafonds plus élevés, assurance voyage, assistance prioritaire.",
