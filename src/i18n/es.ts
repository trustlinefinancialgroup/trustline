...
export const es: Dict = {
  ...
  products: {
    ...
    tierHint: "Las categorías están sujetas a aprobación — nuestro equipo confirma la categoría y el límite finales.",
    tiers: {
      GOLD: "Gold",
      PLATINUM: "Platinum",
      BLACK: "Black",
    ...
    tierBlurbs: {
      GOLD: "Recompensas diarias y un límite inicial.",
      PLATINUM: "Límites más altos, cobertura de viaje y soporte prioritario.",
